...
class BneTrainer(Trainer):
    ...
    """
    def __new__(cls, /, **kwargs) -> BneTrainer: ...
    @property
    ...
    @property
    def max_ngram_length(self, /) -> int | None: ...
    @max_ngram_length.setter
    def max_ngram_length(self, /, limit: int | None) -> None: ...
    @property
    ...
    @property
    def min_scale_frequency(self, /) -> int: ...
    @min_scale_frequency.setter
    def min_scale_frequency(self, /, freq: int) -> None: ...
    @property
